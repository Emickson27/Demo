/*
 * Concert.java
 * Represents a Concert event with specific attributes and behaviors.
...
public class Concert extends Event {
    ...
    public Concert(int eventId, String name, String date, String time,
        ...
        super(eventId, name, date, time, vipPrice, goldPrice, silverPrice, bronzePrice,
              generalPrice, isFireworksIncluded, venue);
    }
